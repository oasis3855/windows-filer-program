========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : FileCpEx
========================================================================


AppWizard が生成した FileCpEx には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには FileCpEx を構成している各ファイルの概要説明が含まれています。
...
FileCpEx.h
    ...
    みます） をインクルードし、また CFileCpExApp アプリケーションクラスを宣
    言します。

FileCpEx.cpp
    このファイルは CFileCpExApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\FileCpEx.ico
    ...
    ルです。このアイコンはリソース ファイル FileCpEx.rc によってインクルード
    されます。
...
FileCpExDlg.h, FileCpExDlg.cpp - ダイアログ
    これらのファイルは CFileCpExDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な FileCpEx.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) FileCpEx.pch 
