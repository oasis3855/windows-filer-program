========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : ShiftTime
========================================================================


AppWizard が生成した ShiftTime には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには ShiftTime を構成している各ファイルの概要説明が含まれています。
...
ShiftTime.h
    ...
    みます） をインクルードし、また CShiftTimeApp アプリケーションクラスを宣
    言します。

ShiftTime.cpp
    このファイルは CShiftTimeApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\ShiftTime.ico
    ...
    ルです。このアイコンはリソース ファイル ShiftTime.rc によってインクルード
    されます。
...
ShiftTimeDlg.h, ShiftTimeDlg.cpp - ダイアログ
    これらのファイルは CShiftTimeDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な ShiftTime.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) ShiftTime.pch 
